        ...
        <section className="live-streaming" data-section-order="live_streaming">
            <div className="ornaments-wrapper">
                ...
                <div className="orn-lv-4 right">
                    <div className="image-wrap" data-aos="zoom-out" data-aos-duration="600" data-aos-delay="250">
            ...
            <div className="inner">
                <div className="head">
                    <h1 data-aos="zoom-in" data-aos-duration="500">{content.liveStreamingTitle}</h1>
                ...
                <div className="body">
                    <div className="streaming-info"><div className="p-relative">
                        ...
                        <div className="preview  wide  youtube " data-aos="fade-up" data-aos-duration="500">
                    ...
                    </div><div className="link" data-aos="fade-up" data-aos-duration="500">
