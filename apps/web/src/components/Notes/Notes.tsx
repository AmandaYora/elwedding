...
export default function Notes({ content }: NotesProps) {
  return (
    <section className="notes-container" data-section-order="greet_thanks">
      <div className="thankyou" data-aos="zoom-in" data-aos-duration="1250" data-aos-delay="900">
        <div className="ornaments-wrapper">
          <div className="orn-qt-1 left">
            <div className="orn-qt-1-3">
              <div className="image-wrap" data-aos="zoom-in-up" data-aos-duration="900" data-aos-delay="400">
