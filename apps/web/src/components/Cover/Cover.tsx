        ...
        <section className="cover " data-section-order="cover">
            ...
            <div className="ornaments-wrapper">
                <div className="orn-cover-4 center">
                    <div className="image-wrap" data-aos="zoom-out-up" data-aos-duration="1100" data-aos-delay="650">
            ...
            <div className="inner">
                ...
                <div className="head" data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="1500">
                                            <div className="logo-wrap" data-aos="fade-down" data-aos-duration="1500" data-aos-delay="1500">
                            <img decoding="async" src={content.coverLogoUrl} alt="" className="logo" />
                        </div>
                                        <p data-aos="fade-down" data-aos-duration="1500" data-aos-delay="1500">Wedding Invitation</p><h1 data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="1500">{content.groomName} & {content.brideName}</h1><p data-aos="fade-up" data-aos-duration="1500" data-aos-delay="1500">{content.hashtag}</p>                </div>
                ...
                */}
                <div className="body highlight" data-aos="zoom-in-up" data-aos-duration="1450" data-aos-delay="350">
            ...
            <div className="ornaments-wrapper">
                <div className="orn-cover-3 left">
                    <div className="image-wrap" data-aos="zoom-in-down" data-aos-duration="1450" data-aos-delay="900">
                ...
                <div className="orn-cover-2 left">
                    <div className="image-wrap" data-aos="zoom-in-right" data-aos-duration="1450" data-aos-delay="900">
                        <img decoding="async" src="/media/template/arsya/Orn-07.webp" width="400" height="1114" alt="" />
                    </div>
                    <div className="orn-cover-2-1">
                        <div className="image-wrap" data-aos="zoom-in-right" data-aos-duration="1200" data-aos-delay="650">
                ...
                <div className="orn-cover-1 left">
                    ...
                    <div className="orn-cover-1-3">
                        <div className="orn-cover-1-3-1">
                            <div className="image-wrap" data-aos="zoom-in-right" data-aos-duration="1750" data-aos-delay="1050">
                                <img decoding="async" src="/media/template/arsya/Orn-05.webp" width="400" height="1019" alt="" />
                            </div>
                        </div>
                        <div className="orn-cover-1-3-2">
                            <div className="image-wrap" data-aos="zoom-in-right" data-aos-duration="1650" data-aos-delay="1000">
                                <img decoding="async" src="/media/template/arsya/Orn-06.webp" width="400" height="1026" alt="" />
                            </div>
                        </div>
                        <div className="image-wrap" data-aos="zoom-in-right" data-aos-duration="1600" data-aos-delay="950">
                            <img decoding="async" src="/media/template/arsya/Orn-04.webp" width="400" height="351" alt="" />
                        </div>
                    </div>
                    <div className="orn-cover-1-2">
                        <div className="image-wrap" data-aos="fade-up-left" data-aos-duration="1450" data-aos-delay="850">
                            <img decoding="async" src="/media/template/arsya/Orn-03.webp" width="400" height="841" alt="" />
                        </div>
                    </div>
                    <div className="orn-cover-1-1">
                        <div className="image-wrap" data-aos="zoom-in-right" data-aos-duration="1300" data-aos-delay="750">
                ...
                <div className="orn-cover-5 center">
                    <div className="image-wrap" data-aos="zoom-in-up" data-aos-duration="1450" data-aos-delay="900">
