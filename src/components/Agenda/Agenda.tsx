        ...
        <div className="ornaments-wrapper">
          ...
          <div className="orn-agenda-1">
            <div className="image-wrap" data-aos="zoom-out" data-aos-duration="1500" data-aos-delay="1000">
              <img src="/media/template/arsya/Orn-34.png" alt="" />
            </div>
          </div>
          ...
          <div className="orn-agenda-2 left">
            <div className="orn-agenda-2-1">
              <div className="image-wrap" data-aos="zoom-out-down" data-aos-duration="1500" data-aos-delay="1000">
                <img src="/media/template/arsya/Orn-36.png" alt="" />
              </div>
            </div>
            <div className="image-wrap" data-aos="zoom-out" data-aos-duration="1500" data-aos-delay="1000">
            ...
            <div className="event-item">
              <div className="event-head">
                <div className="event-head-wrapper">
                  <h3 className="event-day" data-aos="fade-up" data-aos-duration="1000">Saturday, </h3>
                  <h3 className="event-day" data-aos="fade-up" data-aos-duration="1000">16<sup>th</sup> May 2026</h3>
                </div>
              </div>
              <div className="activity-wrap  same-location ">
                <div className="activity-item">
                  <div className="ornaments-wrapper">
                    <div className="orn-ev-1">
                        ...
                        <div className="orn-ev-2-2">
                          <div className="orn-ev-2-2-2">
                            <div className="image-wrap" data-aos="zoom-in-up" data-aos-duration="2200" data-aos-delay="1400">
                              <img src="/media/template/arsya/Orn-28.png" alt="Orn" />
                            </div>
                          </div>
                          <div className="orn-ev-2-2-1">
                            <div className="image-wrap" data-aos="zoom-in-up" data-aos-duration="2200" data-aos-delay="1400">
                              <img src="/media/template/arsya/Orn-05.png" alt="Orn" />
                            </div>
                          </div>
                          <div className="image-wrap" data-aos="zoom-in-up" data-aos-duration="2000" data-aos-delay="1200">
                            <img src="/media/template/arsya/Orn-08.png" alt="Orn" />
                          </div>
                        </div>
                        <div className="orn-ev-2-1">
                          <div className="image-wrap" data-aos="zoom-in-up" data-aos-duration="1800" data-aos-delay="1000">
                            <img src="/media/template/arsya/Orn-03.png" alt="Orn" />
                          </div>
                        </div>
                        <div className="image-wrap" data-aos="zoom-in-up" data-aos-duration="1800" data-aos-delay="1000">
                          <img src="/media/template/arsya/Orn-39.png" alt="Orn" />
                        </div>
                      </div>
                      ...
                      <div className="image-wrap" data-aos="fade-up" data-aos-duration="1800" data-aos-delay="1000">
                        <img src="/media/template/arsya/Orn-37.png" alt="Orn" />
                      </div>
                    </div>
                  ...
                  <div className="activity-content">
                    <div className="activity-head">
                      <h3 className="activity-title" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="450" data-aos-anchor-placement="top-bottom">Akad Nikah</h3>
                      ...
                      <p className="activity-time" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="450" data-aos-anchor-placement="top-bottom">09:00 - 10:00</p>
                    </div>
                    <div className="activity-details">
                      <p className="activity-hall" data-aos="fade-up" data-aos-duration="1000">favehotel Padjajaran Bogor</p>
                      <p className="activity-address" data-aos="fade-up" data-aos-duration="1000">Jl. Cidangiang No.1, Tegallega, Kecamatan Bogor Tengah, Kota Bogor, Jawa Barat 16129, Indonesia</p>
                      <p className="activity-city" data-aos="fade-up" data-aos-duration="1000">Kota Bogor</p>
                      <div className="activity-link-wrap" data-aos="fade-up" data-aos-duration="1000">
                        <a href="https://maps.google.com/?cid=10465024281465579158" className="event-link" target="_blank">
                ...
                <div className="activity-item">
                  ...
                  <div className="activity-content">
                    <div className="activity-head">
                      <h3 className="activity-title" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="450" data-aos-anchor-placement="top-bottom">Resepsi</h3>
                      <div data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="450">
                      ...
                      <p className="activity-time" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="450" data-aos-anchor-placement="top-bottom">11:00 - 14:00</p>
                    </div>
                    <div className="activity-details">
                      <p className="activity-hall" data-aos="fade-up" data-aos-duration="1000">favehotel Padjajaran Bogor</p>
                      <p className="activity-address" data-aos="fade-up" data-aos-duration="1000">Jl. Cidangiang No.1, Tegallega, Kecamatan Bogor Tengah, Kota Bogor, Jawa Barat 16129, Indonesia</p>
                ...
                <div className="dress-inner-wrap">
                  <div className="dress-inner">
                    <div className="dress-header" data-aos="fade-up" data-aos-duration="1000">
                      ...
                      <p className="dress-desc">Wear a long gown or formal gown, black tie or bow tie</p>
                    </div>
                    <div className="dress-body">
                          ...
                          <div className="dress-itwrap">
                            <div className="dress-preview man-preview">
                              <div className="dress-icon">
                                <img className="dress-icon-img" src="/assets/icons/ic-dress-man-formal.png" alt="Dress Man Formal" width="36" height="36" />
                        ...
                        <div className="dress-item wm ">
                          <div className="dress-itwrap">
                            <div className="dress-preview woman-preview">
                              <div className="dress-icon">
                                <img className="dress-icon-img" src="/assets/icons/ic-dress-woman-formal.png" alt="Dress Woman Formal" width="36" height="36" />
                      ...
                      <div className="dress-footer" data-aos="fade-up" data-aos-duration="1000">
                        <p className="dress-note">Notes : Garden Party (get a cardigan/sweater ready in case it gets cold!)</p>
                      </div>
                    </div>
                  </div>
                </div>
