                ...
                <div className="orn-wrapper">
                    <div className="orn-footnote-logo">
                        <div className="image-wrap" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">
                            <img src="/media/photos/photo-21.webp" alt="" className="logo" />
                        </div>
                    </div>
                </div>

                <div className="content">
                    <p className="top-text" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">Wedding Invitation</p>                    <h2 className="footnote-title" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">Ariana<br />&<br />Adrian</h2>                    <p className="bottom-text" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">#AriaMeetsAdrian</p>                </div>
