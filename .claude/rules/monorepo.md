...
- `knowledge/` is the project's only knowledge rack. There is no parallel `docs/`.
- When sources disagree, follow `knowledge/SOURCE_PRIORITY.md` — and report the conflict.
